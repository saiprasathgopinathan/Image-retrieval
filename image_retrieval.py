...
if modelName in ["simpleAE", "convAE"]:
    if trainModel:
        print("GOING TO TRAIN MODEL= ",modelName)
        model.compile(loss="binary_crossentropy", optimizer="adam")
        
        # model.fit_generator(X_train, n_epochs=n_epochs, batch_size=32)
...
print("Inferencing embeddings using trained model...")
...
for i, emb_flatten in enumerate(E_test_flatten):
    _, indices = knn.kneighbors([emb_flatten]) # find k nearest train neighbours which is 5
