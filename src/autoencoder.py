...
class AutoEncoder():
    ...
    def fit_generator(self, X, n_epochs, batch_size=256):
        ...
        self.autoencoder.fit_generator(dataAugmentaion.flow(X_train, X_train, batch_size = 32), 
                                validation_data = (X_valid, X_valid), steps_per_epoch = len(X_train) // 32,
                                epochs = 10)
    ...
    #     test_generator = test_datagen.flow_from_directory(X)

    #     return self.encoder.predict_generator(test_generator)
